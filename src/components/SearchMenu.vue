    ...
    <el-menu :collapse="isCollapse" @select="handleSelect">
        ...
        <el-submenu index="3" >
             <template slot="title">
                ...
                <span slot="title">分数</span>
            </template>
            <el-tag v-if="selectGrade" type="success" closable effect="dark"  :disable-transitions="true" @close="handleClose(3,selectGrade)">{{selectGrade}}</el-tag>
            <el-menu-item-group v-else>
                <el-menu-item index="90">90分以上</el-menu-item>
                <el-menu-item index="80">80分以上</el-menu-item>
                <el-menu-item index="70">70分以上</el-menu-item>
                <el-menu-item index="60">60分以上</el-menu-item>
            </el-menu-item-group>
        </el-submenu>
    </el-menu>
</div>
